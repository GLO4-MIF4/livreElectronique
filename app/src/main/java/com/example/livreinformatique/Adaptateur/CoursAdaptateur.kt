...
import com.example.livreinformatique.Cours_update
import com.example.livreinformatique.R

class CoursAdaptateur (private val userData: List<Lecons>) :
    RecyclerView.Adapter<CoursAdaptateur.ViewHolder>() {

//    --------------------------------- ecouteur -----------------------------

    private var listener: Cours_update.MyItemClickListener? = null

    fun setOnItemClickListener(listener: Cours_update.MyItemClickListener) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.iten_list_cours,parent ,false)
    ...
    inner class ViewHolder (itenView : View) : RecyclerView.ViewHolder(itenView) , View.OnClickListener{
        ...
        override fun onClick(v: View?) {
            listener?.onItemClick(adapterPosition , itemView.parent )
        }
